...
export default function FeedbackModal({ isOpen, onClose }: FeedbackModalProps) {
  ...
  return (
    <>
      ...
      {/* Slide-over Panel */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-2xl bg-gradient-to-b from-indigo-950 via-purple-900 to-black z-50 shadow-2xl overflow-y-auto animate-slide-in">
